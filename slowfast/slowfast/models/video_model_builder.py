...
class ResNet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if self.use_mlp:
            self.cls_head = nn.Sequential(nn.Linear(self.output_size, 4608), nn.ReLU(), nn.Linear(4608, 2408), nn.ReLU(), nn.Linear(2408, cfg.MODEL.NUM_CLASSES))
        else:
